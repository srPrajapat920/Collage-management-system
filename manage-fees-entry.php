                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            <h3 class="box-title">Fees Entry List</h3><br/>
                            <?php echo $msg; ?>
                            <form name="searchform" method="post" action="manage-fees-entry.php">
                                <table style="position: relative;float: right;" >
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td><a href="add-fees-entry.php?act=add" class="btn btn-warning">Add Fees Entry</a></td>
                                    </tr>
                                </table>
                            </form>
                        </div>
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped" style="text-align: center;">
                                ...
                                <tbody>
                                <?php
                                $blogQuery = "select * from student_fees_details where semester='$studclass'";
                                ...
                                if($totalrows>0)
                                {
                                    ...
                                    while($row = mysqli_fetch_array($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td ><a href="add-fees-entry.php?act=u&id=<?php echo $receipt_id; ?>" class="btn btn-xs btn-primary">Edit</a></td>
