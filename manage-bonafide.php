                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            <h3 class="box-title">Bonafide Certificate</h3><br/>
                            <?php echo $msg; ?>
                            <form name="searchform" method="post" action="manage-Bonafide.php">
                                <table style="position: relative;float: right;" >
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td><a href="add-bonafide.php?act=add" class="btn btn-warning">Add Bonafide Certificate</a></td>
                                    </tr>
                                </table>
                            </form>
                        </div>
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped" style="text-align: center;">
                                ...
                                <tbody>
                                <?php
                                $blogQuery = "select * from bonafide_certi ";
                                ...
                                if($totalrows>0)
                                {
                                    ...
                                    while($row = mysqli_fetch_array($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td ><a href="bonafide-certi-pdf.php?id=<?php echo $id; ?>" class="btn btn-xs btn-primary">Print</a></td>
                                        </tr>
                                        <?php
                                        $i = $i + 1;
                                    }
