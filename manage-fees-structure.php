                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            <h3 class="box-title">Fees Structure</h3><br/>
                            <?php echo $msg; ?>
                            <form name="searchform" method="post" action="manage-fees-structure.php">
                                <table style="position: relative;float: right;" >
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td><a href="add-fees-structure.php?act=add" class="btn btn-warning">Add Fees Structure</a></td>
                                    </tr>
                                </table>
                            </form>
                        </div>
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped" style="text-align: center;">
                                ...
                                <tbody>
                                <?php
                                $blogQuery = "select * from fees_structure ";
                                ...
                                if($totalrows>0)
                                {
                                    ...
                                    while($row = mysqli_fetch_array($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $fees_amount;?></td>
                                            <td ><a href="add-fees-structure.php?act=u&id=<?php echo $id; ?>" class="btn btn-xs btn-primary">Edit</a></td>
