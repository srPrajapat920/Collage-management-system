                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            <h3 class="box-title">Students</h3><br/>
                            <?php echo $msg; ?>
                            <form name="searchform" method="post" action="manage-students.php">
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped" style="text-align: center;">
                                ...
                                <tbody>
                                <?php
                                $blogQuery = "select * from student where current_semester='$studclass'";
                                ...
                                if($totalrows>0)
                                {
                                    ...
                                    while($row = mysqli_fetch_array($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td ><a href="add-student.php?act=u&id=<?php echo $row['id']; ?>" class="btn btn-xs btn-primary">Edit</a></td>
                                        </tr>
                                        <?php
                                        $i = $i + 1;
                                    }
